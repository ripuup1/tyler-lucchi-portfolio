...
const categories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "ChatGPT / GPT-4", level: "Advanced", percent: 75 },
      { name: "Figma (Pro)", level: "Intermediate", percent: 55 },
      { name: "OpenClaw / MCP", level: "Beginner", percent: 25 },
      { name: "AI Workflow Automation", level: "Intermediate", percent: 55 },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "Brand Strategy & Positioning", level: "Intermediate", percent: 60 },
      { name: "Social Media Marketing", level: "Intermediate", percent: 55 },
      { name: "Competitive Analysis", level: "Intermediate", percent: 60 },
    ],
  },
  {
    title: "SOFT SKILLS",
